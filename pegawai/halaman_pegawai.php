...
<body style="background-color: #e9ecef">
  ...
  <div id="appCapsule">
    <div class="section bg-info" id="user-section">
      <div id="user-detail">
        ...
        <div id="user-info">
          <h2 id="user-name">Pegawai</h2>
          <span id="user-role"><?php echo $_SESSION['username']; ?></span>
        </div>
      </div>
    </div>
  ...
  <script src="pegawai/assets/js/plugins/jquery-circle-progress/circle-progress.min.js"></script>
